  ...
  return (
    <main className="flex-1 flex flex-col h-full bg-darker-charcoal">
      ...
      <header className="h-16 border-b border-zinc-800 flex items-center px-4">
        ...
        <h1 className="ml-4 text-lg font-semibold text-white">AI Career Assistant</h1>
      </header>

      {/* Messages area */}
      <div className="flex-1 overflow-hidden">{activeConversationId ? <MessageList /> : <EmptyState />}</div>
