export function AIMatchingIcon({ className = "w-12 h-12" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2L2 7L12 12L22 7L12 2Z" fill="url(#gradient1)" stroke="currentColor" strokeWidth="2"/>
...
export function ResumeIcon({ className = "w-12 h-12" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="4" y="2" width="16" height="20" rx="2" fill="url(#gradient2)" stroke="currentColor" strokeWidth="2"/>
...
export function RocketIcon({ className = "w-12 h-12" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.5 16.5C4.5 16.5 5.5 14.5 8 14.5C10.5 14.5 11 16.5 13.5 16.5C16 16.5 17 14.5 17 14.5" stroke="currentColor" strokeWidth="2"/>
      <path d="M12 3L12 7M12 3C8 3 6 8 6 12L12 18L18 12C18 8 16 3 12 3Z" fill="url(#gradient3)" stroke="currentColor" strokeWidth="2"/>
