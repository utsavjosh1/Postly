...
export function ResumePage() {
  ...
  const { resumes, activeResume, isLoading, setResumes, setActiveResume, setLoading } =
    useResumeStore();
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            <div>
              <h2 className="text-lg font-medium text-foreground">Upload New Resume</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-medium text-foreground">Your Resumes</h2>
                <p className="text-sm text-muted-foreground mt-1">
        ...
        {activeResume && activeResume.parsed_text && (
          <div className="mt-12 space-y-4">
            <h2 className="text-lg font-medium text-foreground">Resume Preview</h2>
