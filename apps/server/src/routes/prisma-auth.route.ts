...
router.post("/request-password-reset", PrismaAuthController.requestPasswordReset);
...
router.post("/change-password", prismaAuthenticate, PrismaAuthController.changePassword);
