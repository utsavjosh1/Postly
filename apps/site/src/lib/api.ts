...
class JobsAPI {
  ...
  static async getJobs(
    ...
    if (params.seniorityLevel)
      searchParams.set("seniorityLevel", params.seniorityLevel);
    if (params.category) searchParams.set("category", params.category);
    if (params.skills?.length)
      searchParams.set("skills", params.skills.join(","));
    if (params.salaryMin)
      searchParams.set("salaryMin", params.salaryMin.toString());
    if (params.salaryMax)
      searchParams.set("salaryMax", params.salaryMax.toString());
