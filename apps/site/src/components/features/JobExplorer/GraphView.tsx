        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderColor:
                hoveredNode === node.id ? node.color : "rgba(255,255,255,0.2)",
              boxShadow:
                hoveredNode === node.id ? `0 0 20px ${node.color}40` : "none",
            }}
          >
            <div
              className="transition-colors duration-300"
              style={{
                color: hoveredNode === node.id ? node.color : "#6b7280",
              }}
            >
              {node.icon}
            </div>
