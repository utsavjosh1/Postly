...
ALTER TABLE "conversations" ADD COLUMN "model" varchar(100);--> statement-breakpoint
ALTER TABLE "conversations" ADD COLUMN "is_archived" boolean DEFAULT false;--> statement-breakpoint
...
CREATE INDEX "idx_discord_guild" ON "discord_configs" USING btree ("guild_id");